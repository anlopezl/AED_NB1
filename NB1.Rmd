...
-   Nominal (cualitativa). Ej: Unidad de masa en la que se mide la producción de carbón.
    ...
    -   Relación de **igualdad - desigualdad**: Dos paises con producción de carbón en toneladas tienen *la misma* unidad de masa en la medición. Un pais con producción de carbón en kilogramos y otro en toneladas tienen *diferente* unidad de masa.
...
h_freq = hist(charcoal_chh19$Quantity,
              main = 'Histograma de consumo de carbón por paises-áreas\nAño 2019',
...
hist(charcoal_prd19$Quantity, # Histograma
     ...
     main = 'Histograma con KDE de producción de carbón por paises - áreas\nAño 2019',
     xlab = 'Producción (en miles de toneladas métricas) de carbón',
     ylab = 'Densidad')
